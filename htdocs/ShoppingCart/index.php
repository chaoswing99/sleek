...
if(isset($_POST['cart'])) {
	...
	// $result = addCart($conn, $productName, $price);
		  ...
		  <div class="col-sm-4 col-md-3">
		    	<div class="thumbnail">
				      ...
				      <div class="caption">
				        ...
				        <p><?= $data['price'] . " PHP"; ?></p>
				        <p><a href="addtocart.php?id=" class="btn btn-primary" role="button">View Details</a> <a href="#" class="btn btn-default" name="cart" role="button">Add to Cart</a></p>
				     </div>
		   	 	</div>
		 	 </div>
		     <?php endwhile; ?>
