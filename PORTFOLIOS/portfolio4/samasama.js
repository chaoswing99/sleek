// SAMA SAMANG FUNCTION SA ISANG FUNCTION
// REVISION NG REGISTER.JS
...
function alert1 () {
		...
		else if (m.checked==false && o.checked == false && f.checked==false) {
			alert("alien ka ba ? click click din");
		}

		else if (c1.checked == false && c2.checked == false && c3.checked == false && c4.checked == false && c5.checked == false && c6.checked == false) {
			alert("color blinded ka ba ? kulay kulay din");
		}
